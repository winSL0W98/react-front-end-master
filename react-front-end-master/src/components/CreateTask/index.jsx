                            ...
                            <div className="create-task--body__type">
                                <div className="create-task--body__type__datetime">
                                    ...
                                    <div className="create-task--body__type__datetime--totalstart">
                                        <div
                                            className="create-task--body__type__datetime--totalstart--datatimestartproject">
                                            <label
                                                className="create-task--body__type__datetime--totalstart--labelstartdata">
                                                Дата
                                            </label>
                                            <input type="date"
                                                   className="create-task--body__type__datetime--InputStartDate"/>
                                        </div>

                                        <div className="create-task--body__type__datetime--totalstart--timestart">
                                            <label
                                                className="create-task--body__type__datetime--totalstart--labeltimestart">
                                                Время
                                            </label>
                                            <input
                                                type="time"
                                ...
                                <div className="create-task--body__type__datetimeend">
                                    ...
                                    <div className="create-task--body__type__datetimeend--totalend">
                                        <div
                                            className="create-task--body__type__datetimeend--totalend--datatimestartproject">

                                            <label
                                                className="create-task--body__type__datetimeend--totalend--labelenddata">
                                                Дата
                                            </label>
                                        ...
                                        <div className="create-task--body__type__datetimeend--totalend--timeend">
                                            <label
                                                className="create-task--body__type__datetimeend--totalend--labeltimeend">
                                                Время
                                            </label>
                                            <input type="time"
